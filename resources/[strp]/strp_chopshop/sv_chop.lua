local shoppingList = {
    [1507916787] = { name = "Picador", costs = 150, model = "picador", damageMultiplier = 1  },
    [-1150599089] = { name = "Primo", costs = 150, model = "primo", damageMultiplier = 1 },
    ...
    [65402552] = { name = "Youga", costs = 130, model = "youga", damageMultiplier = 2 },
    ...
    [1777363799] = { name = "Washington", costs = 110, model = "washington", damageMultiplier = 2 },
