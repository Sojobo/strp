Locales['en'] = {
  ...
  ['start_job'] = 'press ~b~F4~s~ to start the job',
  ...
  ['sell_cashing'] = '~g~Cashing~s~ Salvage...',
  ['sell_nobills'] = '~r~You don\'t have any Salvage to cash',
  ['sell_nomorebills'] = '~r~You don\'t have any more Salvage to cash',
