...
local function Harvest(source)
	SetTimeout(4000, function()
		...
		if PlayersHarvesting[source] == true then
			...
			if GazBottleQuantity + xInventoryWeight > xInventorylimit then
...
local function Harvest2(source)
	SetTimeout(4000, function()
		...
		if PlayersHarvesting2[source] == true then
			...
			if FixToolQuantity + xInventoryWeight > xInventorylimit then
				TriggerClientEvent('esx:showNotification', source, _U('you_do_not_room'))
			else
...
local function Harvest3(source)
	SetTimeout(4000, function()
		...
		if PlayersHarvesting3[source] == true then
			...
			if CaroToolQuantity + xInventoryWeight >= xInventorylimit then
				TriggerClientEvent('esx:showNotification', source, _U('you_do_not_room'))
			else
...
AddEventHandler('esx_mechanicjob:putStockItems', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mechanic', function(inventory)
		...
		if item.count >= 0 and count <= xInventoryWeight then
