...
Config.WeedPrice = 180	-- sell price for single, not pooch (black money)
Config.MethPrice = 250	-- sell price for single, not pooch (black money)
Config.CokePrice = 240	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 300	-- sell price for single, not pooch (black money)
Config.DistanceFromCity = 3000 -- set distance that player cant sell drugs too far from city
