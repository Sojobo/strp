...
local banListM = {
	...
	[12] = { -- Helmet (made up, not ped prop)
		[1] = true,
		[6] = true,
		[8] = true,
		[10] = true,
...
function ApplySkin(skin, clothes)
	...
	if ((skin['sex'] == 0 and not banListM[8][Character['tshirt_1']]) or (skin['sex'] == 1 and not banListF[8][Character['tshirt_1']])) then
		SetPedComponentVariation	(playerPed, 8,		Character['tshirt_1'],			Character['tshirt_2'], 2)					-- Tshirt
	end
	
	if ((skin['sex'] == 0 and not banListM[11][Character['torso_1']]) or (skin['sex'] == 1 and not banListF[11][Character['torso_1']])) then
		SetPedComponentVariation	(playerPed, 11,		Character['torso_1'],			Character['torso_2'], 2)					-- torso parts
	end
	
	if ((skin['sex'] == 0 and not banListM[10][Character['decals_1']]) or (skin['sex'] == 1 and not banListF[10][Character['decals_1']])) then
		SetPedComponentVariation	(playerPed, 10,		Character['decals_1'],			Character['decals_2'], 2)					-- decals
	end

	if ((skin['sex'] == 0 and not banListM[4][Character['pants_1']]) or (skin['sex'] == 1 and not banListF[4][Character['pants_1']])) then
	...
	elseif ((skin['sex'] == 0 and not banListM[12][Character['helmet_1']]) or (skin['sex'] == 1 and not banListF[12][Character['helmet_1']])) then
