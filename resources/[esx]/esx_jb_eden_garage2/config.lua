...
Config.Garages = {
	Garage_Centre = {	
		...
		SpawnPoint = {
			...
			HelpPrompt = "Press ~INPUT_PICKUP~ to withdraw a vehicle",
...
Config.GaragesMecano = {
	Bennys = {
		...
		SpawnPoint = {
			...
			Heading = 303.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to take a vehicle out of the Pound",
			Functionmenu = ListVehiclesFourriereMenu,
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to enter the vehicle at the Pound",
