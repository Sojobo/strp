...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	local xInventoryWeight = sourceXPlayer.getInventoryWeight()
	local xInventorylimit = sourceXPlayer.getInventoryWeightMax()
	...
	elseif itemType == 'item_account' then
		...
		sourceXPlayer.addMoney(itemName, math.ceil(round(amount / 20))) -- 20% confiscated into your pocket
