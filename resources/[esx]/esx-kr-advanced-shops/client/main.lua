...
function Robbery(id)
	...
	local coords1 = {
        ...
        [5] = {x = 1395.49, y = 3612.94, z = 35.00, heading = 22.18},
        [6] = {x = -2959.5, y = 387.78, z = 14.04, heading = 171.58},
        [7] = {x = 2674.36, y = 3288.0, z = 55.20, heading = 339.44},
        [8] = {x = -42.76, y = -1749.36, z = 29.42, heading = 320.15},
        [9] = {x = 1160.77, y = -314.03, z = 69.21, heading = 10.81},
        [10] = {x = -708.12, y = -904.24, z = 19.15, heading = 5.05},
        [11] = {x = -1828.23, y = 799.83, z = 138.16, heading = 53.63},
        [12] = {x = 1707.87, y = 4919.76, z = 41.99, heading = 237.41},
        [13] = {x = 1961.55, y = 3748.67, z = 32.20, heading = 304.34},
        [14] = {x = 1126.26, y = -980.84, z = 45.42, heading = 9.13},
        [15] = {x = 30.45, y = -1339.88, z = 29.5, heading = 269.79},
        [16] = {x = -1382.24, y = -632.57, z = 30.82, heading = 213.19},
        [17] = {x = 545.07, y = 2663.47, z = 42.16, heading = 96.45},
