...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.CokeProcess.CokeProcessing.coords, true) < 6 then
...
function ProcessCoke()
	...
	while timeLeft > 0 do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(playerPed), Config.CokeProcess.CokeProcessing.coords, false) > 8 then
