...
cfg = {
	...
	damageFactorBody = 5.5,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorPetrolTank = 30,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	degradingFailureThreshold = 700,			-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 350,			-- Below this value, health cascading failure will set in
