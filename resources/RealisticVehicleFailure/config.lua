...
cfg = {
	...
	damageFactorPetrolTank = 80.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	weaponsDamageMultiplier = 3.0,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	degradingHealthSpeedFactor = 30,			-- Speed of slowly degrading health, but not failure. Value of 10 means that it will take about 0.25 second per health point, so degradation from 800 to 305 will take about 2 minutes of clean driving. Higher values means faster degradation
