webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    t.exports = ["Just now", ["About %s seconds ago", "About %s seconds ago"],
        ["Last call was %s minute", "Last call was %s minutes"],
        ["Last call was %s hour", "Last call was %s hours"],
        ["Last call was %s day", "Last call was %s days"],
        ["Last call was %s week", "Last call was %s weeks"],
        ["Last call was %s month", "Last call was %s months"],
        ["Last call was %s an", "Last call was %s ans"]
    ]
}, function(t, e, n) {
    "use strict";
    var s = n(106),
    ...
    t.exports = {
        ...
        staticRenderFns: [function() {
            ...
            return n("div", {
                ...
                attrs: {
                    type: "text",
                    placeholder: "Press Enter to Type Message"
                }
            }), t._v(" "), n("span", {
