...
Config.Strings = {
    ['drive_next'] = 'Drive to the next ~y~checkpoint',
    ['start_npc'] = 'Press ~INPUT_CONTEXT~ to start the race against the NPC',
    ['start_online'] = 'Press ~INPUT_CONTEXT~ to start the race against other players',
    ['stop_online'] = 'Press ~INPUT_CONTEXT~ to unready yourself'
}
...
Config.OnlineRace = {
    [1] = {
        ...
        Text = 'Press ~INPUT_CONTEXT~ to run a race against 2 other players! (Own vehicle)',
