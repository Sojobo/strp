...
Config.OnlineRace = {
    ...
    [3] = {
        Players = 6,
        Type = 'street_race', -- 'street_race' your own vehicle, 'event' you spawn with a vehicle
        Text = 'Press ~INPUT_CONTEXT~ to enter the race for $200',
        Start = {x = 477.63, y = -2049.20, z = 24.39},
        Size = 5.5, 
        StartLine = {
            [1] = {x = 473.05, y = -2052.97, z = 24.08, h = 45},
            [2] = {x = 469.29, y = -2056.62, z = 23.77, h = 42},
            [3] = {x = 465.62, y = -2058.62, z = 23.61, h = 37},
            [4] = {x = 479.92, y = -2044.83, z = 24.31, h = 24},
            [5] = {x = 485.00, y = -2041.71, z = 24.55, h = 60},
            [6] = {x = 488.43, y = -2037.18, z = 24.49, h = 74},
        },
        NumberOfZones = 17,
        Zones = {
            [1] = {x = 259.85, y = -1860.27, z = 26.38},
            [2] = {x = 102.33, y = -1859.22, z = 24.19},
            [3] = {x = -16.68, y = -1706.30, z = 28.83},
            [4] = {x = -11.93, y = -1596.02, z = 28.82},
            [5] = {x = 126.40, y = -1397.85, z = 28.79},
            [6] = {x = 46.83, y = -1140.83, z = 28.82},
            [7] = {x = -76.47, y = -1025.84, z = 27.83},
            [8] = {x = -175.94, y = -1032.91, z = 26.76},
            [9] = {x = -229.14, y = -1132.89, z = 22.52},
            [10] = {x = -361.72, y = -1130.31, z = 28.48},
            [11] = {x = -559.66, y = -1084.81, z = 21.67},
            [12] = {x = -614.74, y = -1075.00, z = 21.87},
            [13] = {x = -682.71, y = -1065.35, z = 15.21},
            [14] = {x = -955.47, y = -1202.86, z = 4.64},
            [15] = {x = -1119.36, y = -933.46, z = 2.10},
            [16] = {x = -1345.82, y = -993.30, z = 7.74},
            [17] = {x = -1511.11, y = -1099.52, z = 2.15}
        },
    },
}
